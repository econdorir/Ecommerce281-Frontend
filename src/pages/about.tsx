    ...
    <>
      ...
      <div className="bg-white text-black mt-20">
        <div className="container mx-auto p-6 pt-20 pb-20">
          ...
          <section className="mb-12 bg-[#FFBF69] p-10 rounded-lg shadow-lg border border-black">
            <h2 className="text-4xl font-semibold mb-2">Nuestra Misión</h2>
            <p className="text-lg">
          ...
          <section className="mb-12 bg-[#CBF3F0] p-10 rounded-lg shadow-md border border-black">
            <h2 className="text-4xl font-semibold mb-2">Nuestros Valores</h2>
          ...
          <section className="mb-12 bg-[#FFBF69] p-10 rounded-lg shadow-md border border-black">
            <h2 className="text-4xl font-semibold mb-2">Antecedentes</h2>
            <p className="text-lg">
          ...
          <section className="mb-12 bg-[#CBF3F0] p-10 rounded-lg shadow-md border border-black">
            <h2 className="text-4xl font-semibold mb-2">Objetivos del Proyecto</h2>
            <p className="text-lg">
          ...
          <section className="mb-12 bg-[#FFBF69] p-10 rounded-lg shadow-md border border-black">
            <h2 className="text-4xl font-semibold mb-2">Nuestro Equipo</h2>
            <p className="text-lg">
          ...
          <section className="bg-[#2EC4B6] p-10 rounded-lg shadow-md border border-black">
            <h2 className="text-4xl font-semibold mb-2">Contáctanos</h2>
            <p className="text-lg">
